    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
          <div class="row">
                ...
                <div class="col-md-6">
                      ...
                      &nbsp; &nbsp;
                      <div class="form-group">
                      <a href="<?php echo base_url() ?>index.php/presupuesto/logout" class="cerrar_sesion_3">Cerrar sesión</a>
                      </div>
                      </form>
                </div>              
          </div>
        ...
        <div class="panel-body">
          ...
          <div class="col-md-12">
            ...
            <div class="tab-content clearfix">
                    <!--Pestaña 1 ===========================================================================-->
                    <?php require('application/views/cliente_new.php'); ?>
                    <!--Pestaña 2 ===========================================================================-->
        ...
        <div class="panel-footer">
          ...
          <div class="btn-toolbar" role="toolbar" aria-label="...">              
              ...
              <div class="btn-group" role="group" aria-label="...">
                <a class="btn btn-primary" href="/presupuestos/index.php/presupuesto/principal" role="button">Volver</a>
              </div>
          </div>
          </div>
          </div>
